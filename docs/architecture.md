...
lines of Python across six modules, 33 routes, six tables, 550 test
functions.
...
550 test functions, which parametrisation expands into over six hundred
...
| --- | --- | --- |
| `app.py` | 2,759 | Routes, queries, the rules, CLI commands |
