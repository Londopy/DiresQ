...
lines of Python across six modules, 27 routes, five tables, 335 test
functions.
...
335 test functions, which parametrisation expands into over three hundred
...
cost of indirection, and at 1,700 lines with 27 routes the concerns aren't
