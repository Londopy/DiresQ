...
lines of Python across six modules, 32 routes, five tables, 458 test
functions.
...
458 test functions, which parametrisation expands into over five hundred
...
cost of indirection, and at 1,700 lines with 32 routes the concerns aren't
