...
lines of Python across six modules, 26 routes, five tables, 310 test
functions.
...
310 test functions, which parametrisation expands into over three hundred
...
cost of indirection, and at 1,700 lines with 26 routes the concerns aren't
