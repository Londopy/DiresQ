...
[![Tests](https://img.shields.io/badge/tests-560%20passing-brightgreen)](tests/test_app.py)
...
**25,400 lines written** — **19,279 lines of code** and 6,121 of
documentation — across **560 test functions**, 705 cases after
parametrisation.
...
560 test functions, which parametrisation expands into 705 cases, covering
