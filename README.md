...
[![Tests](https://img.shields.io/badge/tests-603%20passing-brightgreen)](tests/test_app.py)
...
| **603 test functions** | 597 cases after parametrisation — every route, an adversarial pass |
...
documentation — across **603 test functions**, 748 cases after
parametrisation.
...
603 test functions, which parametrisation expands into 748 cases, covering
