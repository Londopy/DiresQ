...
[![Tests](https://img.shields.io/badge/tests-606%20passing-brightgreen)](tests/test_app.py)
...
| **606 test functions** | 597 cases after parametrisation — every route, an adversarial pass |
...
documentation — across **606 test functions**, 751 cases after
parametrisation.
...
606 test functions, which parametrisation expands into 751 cases, covering
